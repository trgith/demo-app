            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <div class="container">
                        ...
                        <div class="row p-1">
                            <div class="col-lg-10 col-md-12">
                                Fondo de ahorro para el retiro de los policías
                            </div>
                            <div class="col-lg-1 col-sm-6">
                                <div class="custom-control custom-radio custom-control-inline">
                        ...
                        <div class="row p-1">
                            <div class="col-lg-10 col-md-12">
                                Acceso de apoyos para los familiares de policías caídos en cumplimiento del deber
                            </div>
                            <div class="col-lg-1 col-sm-6">
                                <div class="custom-control custom-radio custom-control-inline">
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="container">
                        <div class="row p-1">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <input type="number" class="form-control" id="Cap121TablaEsquemas1">
                            </div>
                            <div class="col-lg-3 col-md-4">
                                8 x 24
                            </div>
        ...
        <div class="d-flex justify-content-around" id="contenedorCambiarSeccion">
            <button type="button" class="btn btn-primary botonCambiarSeccion" onclick="CambiarSeccion('1-2','2-1','1-2-1','2-1-1')">
